...
function wholefv(){
  ...
  if(document.getElementById("phone").value == ""){
    ...
    document.getElementById("phonealert").innerHTML="Phone number is required";
    ...
    for(j=0;j<str.length;j++){
      if(str[j]>'9' || str[j]<'0'){
        document.getElementById("phonealert").style.display="block";
        document.getElementById("phonealert").innerHTML="Phone number should have only numerical values";
        document.getElementById("phone").style.borderColor="red";
        flag=1;
        break;
      }
    ...
    if(flag==0){      
      if(str.length!=10){
        document.getElementById("phonealert").style.display="block";
        document.getElementById("phonealert").innerHTML="Phone number should contain 10 numerical digits";
        document.getElementById("phone").style.borderColor="red";
      }
      else{
